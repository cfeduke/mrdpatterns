...
public class SimpleRandomSampling extends Configured implements Tool {
  public static final String FILTER_PERCENTAGE_KEY = "com.deploymentzone.mrdpatterns.filter_percentage";
  ...
  public static class SimpleRandomSamplingMapper extends Mapper<Object, Text, NullWritable, Text> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
      filterPercentage = context.getConfiguration().getFloat(FILTER_PERCENTAGE_KEY, 0.0f);
    }
  ...
  private void printUsage() {
    System.err.println("Usage: SimpleRandomSampling <percentage> <in> <out>");
